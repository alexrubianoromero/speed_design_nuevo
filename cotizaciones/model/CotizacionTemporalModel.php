...
class CotizacionTemporalModel extends Conexion
{
    ...
    {
        $sql ="insert into cotizaciones_temporal (fecha) values(now() )";
        // die($sql); 
    ...
    {
        $sql = "select max(id) as id from  cotizaciones_temporal "; 
        $consulta = mysql_query($sql,$this->connectMysql());
    ...
    {
        $sql ="insert into cotizaciones_temporal_items  
    ...
    {
        $sql = "select * from cotizaciones_temporal_items where no_factura = '".$idTemp."'  "; 
        $consulta = mysql_query($sql,$this->connectMysql());
