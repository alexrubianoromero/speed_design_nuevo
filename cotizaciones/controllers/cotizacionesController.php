...
require_once($raiz.'/cotizaciones/vista/cotizacionesVista.php');
require_once($raiz.'/cotizaciones/model/CotizacionTemporalModel.php');
require_once($raiz.'/cotizaciones/model/CotizacionModel.php');
...
class cotizacionesController
{
    ...
    public function __construct()
    {
        ...
        $this->ventasTemporalModel = new CotizacionTemporalModel();
        $this->ventasModel = new CotizacionModel();
